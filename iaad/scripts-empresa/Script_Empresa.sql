...
begin;
drop schema if exists Empresa_seunome; -- inclua seu nome
create schema Empresa_seunome; -- Pode usar o comando 'create database empresa_seunome;' (São semelhantes!)
use Empresa_seunome;
